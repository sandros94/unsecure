...
Use `entropy()` as a heuristic that rejects obvious junk. Do not use it to accept anything, and never use it in place of [`secureGenerate`](/generate/secrets/generate) when you are the one producing the value.
